...
public class VideoFileManager {
    ...
    private final Path targetDir_ = Paths.get("videos");
     ...
     * @throws IOException
     */
    public Path saveVideoData(Video v, InputStream videoData) throws IOException {
    ...
    /**
     * Returns stored video as byte array
     *
     * @param v video as object
     * @return video as byte array
     * @throws IOException if video is not found
     */
    public byte[] getVideoData(Video v) throws IOException {
        assert (v != null);
